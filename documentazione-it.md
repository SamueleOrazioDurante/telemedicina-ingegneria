...
### UC-07: Invia Email al Medico

| Campo                  | Descrizione                                                                                                                                                                                                                |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ID**                 | UC-07                                                                                                                                                                                                                      |
| **Nome**               | Invia Email al Medico                                                                                                                                                                                                      |
| **Attore/i**           | Paziente                                                                                                                                                                                                                   |
| **Precondizione**      | Il paziente è autenticato e dispone di un medico di riferimento associato.                                                                                                                                                 |
| **Flusso Principale**  | 1. Il paziente fa clic sul pulsante "Contatta Medico". 2. Il sistema recupera l'indirizzo email del medico di riferimento. 3. Il sistema apre il client mail predefinito con l'indirizzo e l'oggetto precompilati (`mailto:`). |
| **Flusso Alternativo** | 2a. Indirizzo email del medico non configurato → Il sistema mostra un allerta di errore.                                                                                                                                   |
| **Postcondizione**     | Viene avviata la composizione del messaggio email verso il medico di riferimento.                                                                                                                                          |
...
### UC-12: Genera Allerta Glicemia

| Campo                 | Descrizione                                                                                                                                                                                                                                                                                                        |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **ID**                | UC-12                                                                                                                                                                                                                                                                                                              |
| **Nome**              | Genera Allerta Glicemia                                                                                                                                                                                                                                                                                            |
| **Attore/i**          | Sistema (Automatico)                                                                                                                                                                                                                                                                                               |
| **Precondizione**     | È stata inserita una nuova misurazione glicemica o viene caricata la dashboard.                                                                                                                                                                                                                                    |
| **Flusso Principale** | 1. Il sistema invoca il motore di regole mediche (`MedicalRulesEngine`). 2. Il sistema confronta i valori con le soglie (prima del pasto 80-130 mg/dL, dopo il pasto <=180 mg/dL). 3. Se il valore supera le soglie, il sistema valuta la gravità e genera un badge di allerta visibile sia al paziente che al medico. |
| **Postcondizione**    | L'allerta per valore glicemico anomalo viene visualizzata nelle notifiche di dashboard.                                                                                                                                                                                                                            |

### UC-13: Genera Allerta Terapia Mancata

| Campo                 | Descrizione                                                                                                                                                                                                                                                                                                                               |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ID**                | UC-13                                                                                                                                                                                                                                                                                                                                     |
| **Nome**              | Genera Allerta Terapia Mancata                                                                                                                                                                                                                                                                                                            |
| **Attore/i**          | Sistema (Automatico)                                                                                                                                                                                                                                                                                                                      |
| **Precondizione**     | Esistono terapie attive prescritte per il paziente.                                                                                                                                                                                                                                                                                       |
| **Flusso Principale** | 1. Il sistema verifica la corrispondenza tra le assunzioni registrate dal paziente e le prescrizioni del medico. 2. Se le assunzioni giornaliere sono incomplete, mostra un promemoria al paziente. 3. Se il paziente salta le assunzioni per più giorni consecutivi, il sistema genera un allerta visibile al medico nella dashboard. |
| **Postcondizione**    | Le allerte per mancata aderenza terapeutica vengono generate e notificate.                                                                                                                                                                                                                                                                |
